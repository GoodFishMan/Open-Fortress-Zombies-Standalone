"Resource/UI/HudPlayerClass.res"
{
	...
	"PlayerStatusClassImageBG"
	{
		...
		"visible"		"1"
		"enabled"		"1"
        "image"			"../hud/hud_select_blood_fliped"
		"scaleImage"	"1"		
		"teambg_2"		"../hud/hud_select_blood_fliped"
		"teambg_2_lodef"	"../hud/hud_select_blood_fliped"
		"teambg_3"		"../hud/hud_select_blood_fliped"
		"teambg_3_lodef"	"../hud/hud_select_blood_fliped"
		"teambg_4"		"../hud/hud_select_blood_fliped"
		"teambg_4_lodef"	"../hud/hud_select_blood_fliped"					
	}
